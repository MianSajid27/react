...
const Brand = () => {
  ...
  <tr className="customer row d-flex ">
                ...
                <div className="col-sm ">
                  <span className=" Varr rpl  " style={{ padding: "14px" }}>
                    {" "}
                    <th
                      className=""
          ...
          <span  className='cus'> <th >Brand</th>  </span> 
          <span  className='Bran'style={{padding:"14px"}}  >  <th>  < BsSearch/><input className='brho'  placeholder= '  Type your quary and enter press'/></th></span>
          <span >  <th> <button className='ad'>    <span className='plus' ><BsPlus size={"30px"} /></span>Add Brand</button></th></span>
...
<Table >
      ...
      <thead >
        ...
        <tr className="th1 rab">
          <th  className='th' style={{padding:"10px"}}>Image</th>
          <th className='' style={{padding:"10px" }}>Brand</th> 
          <th className='reg' > <span style={{marginLeft:"300px"}}> 	Status </span> </th>
    
        
         
           <th style={{padding:"10px"}} >
            <span style={{marginLeft:"350px"}}> Action</span>  </th>
...
<span style={{marginLeft:"280px"}}> 	no found data </span></td>
          <td style={{padding:"20px"}}> <span style={{marginLeft:"350px"}} > </span> </td>
